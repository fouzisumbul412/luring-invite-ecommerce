  ...
  return (
    ...
    >
      <button
        ...
        className="relative flex items-center justify-center w-14 h-14 bg-[hsl(142_70%_45%)] rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 group"
      >
        {/* Pulse animation */}
        ...
        <AnimatePresence>
          {isHovered && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 10 }}
              className="absolute right-full mr-4 bg-foreground text-background px-4 py-2 rounded-lg text-sm whitespace-nowrap shadow-lg"
            >
              Chat with us!
